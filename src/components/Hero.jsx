...
import { payToMint } from "../Cybergems";
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          >
            ...
            <div className="flex flex-col font-semibold">
              ...
              <span className="text-[#e32970] text-xs">Efe</span>
            </div>
          </a>

          <p className="text-white text-sm font-medium text-center">
            Efe began his career as a software engineer in 2016. <br /> Over the
            years, he has developed proficiency in web development technologies
            including <br /> React, Node.js and Python. His passion for
            innovation have led him to explore the
            <br />
            potential of blockchain technology in web development.
          </p>
